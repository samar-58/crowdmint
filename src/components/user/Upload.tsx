  ...
  return (
    <div className="min-h-screen bg-background py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Main Form Card */}
        <div className="bg-zinc-900/50 backdrop-blur-sm border border-zinc-800 rounded-2xl shadow-xl p-8 mb-8">
          <div className="space-y-8">
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full h-12 px-4 bg-zinc-800/50 border-2 border-zinc-700 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all outline-none text-white placeholder-zinc-500"
              />
        ...
        <div className="mt-8 space-y-4">
          {/* Payment Status Card */}
          {signature && (
            <div className="bg-green-900/20 border-2 border-green-900/50 rounded-xl p-6 animate-fade-in">
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  <h3 className="text-green-400 font-semibold text-lg">Payment Confirmed!</h3>
                  <p className="text-green-500/70 text-sm">Transaction: {signature.slice(0, 8)}...{signature.slice(-8)}</p>
                </div>
              </div>
            </div>
          )}
